        ...
        <section className="mx-auto max-w-5xl px-6 py-12">
          ...
          <div className="mt-10 rounded-3xl border border-white/10 bg-white/5 p-6">
            ...
            <div className="space-y-4 leading-8 text-zinc-400">
              ...
              <p>
                We publish price updates, educational articles, and simple
                market explanations covering topics such as inflation, interest
                rates, the US dollar, and the key factors that influence global
                gold prices.
              </p>
              <p>
