      ...
      <div className="mx-auto max-w-3xl space-y-8">
        ...
        <div className="space-y-4 text-zinc-300 leading-8">
          <p>
            ...
            المتصفح، والصفحات التي تمت زيارتها عبر أدوات التحليل مثل Google
            Analytics.
          </p>
          <p>
        ...
        <div className="space-y-4 text-zinc-400 leading-8">
          <p>
            We respect your privacy. We may collect non-personal data such as
            browser type, device type, and pages visited via analytics tools
