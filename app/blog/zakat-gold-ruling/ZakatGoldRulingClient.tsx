      ...
      <div className="mx-auto max-w-4xl">
        ...
        <article className="rounded-3xl border border-white/10 bg-white/5 p-8">
          ...
          <a
            ...
            className="mt-6 inline-block rounded-xl bg-amber-400 px-6 py-3 font-semibold text-black hover:bg-amber-300"
          >
